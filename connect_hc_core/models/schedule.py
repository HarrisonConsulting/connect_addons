# -*- coding: utf-8 -*-
"""Daily rules and holiday exceptions for a business-hours schedule.

connect.schedule owns the identity and the timezone; the rules that decide
whether it is open right now live here with the lines they evaluate.
"""
